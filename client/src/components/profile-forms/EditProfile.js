...
const EditProfile = ({
  ...
  // useState -> Returns a stateful value (here say formData object), and a function (here say useFormData) to update it.
  ...
  //useState -> Returns a "single" Stateful value "displaySocialInputs" and a function hook to update it
...
//withRouter is used so that the called action (here createProfile )
//can use history.push can be used
